...
Diese Konvention ist als \conv{Raptor Notrump} und \conv{Polish Notrump} bekannt.
...
(siehe Seite~\pageref{sandwichnt}).  Folglich gilt \conv{Raptor} nur als direkter
		...
		\bdsc
			...
			\item[2\NT] starkes Frage-Relais
				\bdsc
					...
					\item[3\SA] stehende 6er-\ufa (wie nach \conv{Ogust})
				\edsc
