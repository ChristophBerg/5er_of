...
\item[1\tre\sep1\pik; 1\SA] 12-14 FP \bal
  \bdsc
  \item[2\tre;\sep2\kar] \underline{\xfer, verlangt 2\kar-\rel}
    \bdsc
    \item[pass] schwach (A2)
    \item[2\coe] 5/4 \pi/\co, \inv\ (B3b)
    \item[2\pik] 5er-\pi, mind. \inv\ (B2)
    \item[2\SA] \bal, \inv, 4er-\pi\ (B3a)
    \item[3\ufa] 5/5, \inv
    \item[3\coe] 5/5, \inv
    \item[3\pik] 6er-\pi, \inv
    \item[3\SA] \nat, 5er-\pi
    \item[4\ufa] 6\good er-\pi, Chicane \ufa\ (Autosplinter)
    \item[4\coe] 6\good er-\co, Chicane \ufa\ (Autosplinter)
    \edsc
  \item[2\kar] 4er\pik, 5\pl{}\kar, genau \inv\ (sonst Walsh)
  \item[2\coe] 5/4 \pik\,+\coe, zum Spielen oder ausbessern
  \item[2\pik] 5er\pik, schwach
  \item[2\SA;\sep3\tre] \underline{\xfer, verlangt 3\tre-\rel}
    \bdsc
    \item[pass] schwach, 4/5\pl\ \pi/\ka
    \item[3\kar] stark, 4/5 \pi/\tr\ (4/5 \pi/\ka nach 1\kar-Er"offnung)
    \item[3\coe] stark, 5/4 \pi/\co
    \edsc
  \item[3\mi] 5/5 \pi/\ufa, \pf
  \item[3\coe] 5/\underline{5} \pik\,+\coe, \pf
  \item[3\pik] 6er\pik, leichtes \slamint\footnotemark[1]
  \item[4\ufa] 6\good er-\pi, Single \ufa\ (Autosplinter)
  \item[4\coe] 6\good er-\pi, Single \coe\ (Autosplinter)
  \edsc
\edsc
...
\bdsc
  \item[1\tre\sep1\pik; 2\kar\sep{}?]~
    ...
    \item[2\pik] 5er-Farbe, schwach oder stark
      ...
      \edsc
    \item[2\SA] \conv{Ingberman}\footnotemark[2], verlangt \rel\ 3\tre, danach:
      \bdsc
