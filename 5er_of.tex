...
und 16+ FP wird im Sprung eingeladen. Nach \conv{2/1} zeigt der Sprung \dots?
...
zeigt nach \conv{1/1} 18\pl FP, nach \conv{2/1} \dots?\pl FP.
...
Antworten mit Fit in \ofa: \conv{Limit-Hebungen}, \conv{Splinter},
\conv{Fit-Jumps}, 4\SA \conv{KCB}, 5\SA \conv{Josephine}, \conv{EKCB}.

Antworten mit Fit in \ufa: \conv{Limit-Hebungen}, 4\uf \conv{KCB}, \conv{Splinter}, \dots?

\minisec{2. Antwort}

Die Hebung der \emph{zweiten} Farbe des Er"offners auf die 3er-Stufe ist nach
\conv{1/1} einladend, nach \conv{2/1} partieforcierend.
...
\bdsc
	...
	\bdsc
		...
		\bdsc
			\item[2\SA] negativ
			\item[3\tre/\ka/\pi] \conv{Cuebid}
			\item[3\coe] positiv, kein \conv{Cuebid}
		\edsc
	...
	\bdsc
		...
		\bdsc
			\item[3\pik] positiv, kein \conv{Cuebid}
			\item[3\SA] negativ
			\item[4\tre/\ka/\co] \conv{Cuebid}
		\edsc
...
\bdsc
  ...
  Accept}).
  Mit schwachen H"anden transferiert der Antwortende mit 3\kar zur"uck, andere
  Gebote sind \conv{Cuebids}:
  \bdsc
    \item[2\pik] 4er-\co, \maxi, \pi-Double
    \item[2\SA] 4er-\co, \maxi, \ka-Double oder 4-3-3-3
    \item[3\tre] 4er-\co, \maxi, \tr-Double
      \bdsc
      \item[3\tre] \tr-\conv{Cuebid} (stark)
      \item[3\kar] \conv{R"ucktransfer} \ra \co (schwach)
      \edsc
