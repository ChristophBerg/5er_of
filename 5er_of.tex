...
\conv{Wolff Sign Off} fordert nach 2\SA-R"uckgebot mit 3\tre ein 3\kar-Relais
an. Es ist n"utzlich in Situationen, in denen der
...
4.-h"ochste. Ausspiel der 10 und 9 verspricht 0 oder 2 h"ohere Karten.
In Partners gereizter wird die 3./5.-h"ochste ausgespielt.
Das st"arkste Ausspiel ist der K"onig: 
\begin{compactdesc}
\item[\suit{KD10xx}] K"onig: Partner soll den Buben deblockieren
\item[\suit{AKB10x}] K"onig: Partner soll die Dame deblockieren
\end{compactdesc}
...
Hat man Partners Farbe unterstützt, so verneint eine hohe Karte eine Figur,
eine kleine Karte zeigt eine Figur (Smith Peter-Markierung).
