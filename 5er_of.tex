...
\minisec{"Ubersicht}
\emph{(NF = Nebenfarbe, OF = Oberfarbe des Antwortenden)}

{\relsize{-2}%
\begin{tabularx}{\columnwidth}{|l|l|l|Y|Y|}
\hline
...
der Weak Two-Farbe. Ein \sa-Gebot des Antwortenden ist zum Spielen.
...
\textbf{1. 3er-Anschluss in der \ofa des Partners zeigen}
\begin{description}
...
\textbf{2. \sa mit Stopper in der vierten Farbe reizen}
\begin{description}
\item[1\coe{}\sep1\pik;~2\tre{}\sep2\kar;~?]~
  \begin{description}
