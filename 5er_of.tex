...
(Alert: 1\kar: \emph{"`keine 4er-\ofa oder m"ochte diese revers reizen"'},
1\SA: \emph{"`kann jede 4er-\ofa enthalten"'})

Ein \ofa-R"uckgebot des Er"offners nach [1\tre-1\kar;] zeigt
\emph{immer} eine unausgeglichene Hand mit langen Treffs.
(Alert: \emph{"`unausgeglichen"'})
...
\subsection{Bietsequenzen nach [1\tre-1\kar{}]}
...
%
\subsection{Bietsequenzen nach 1\SA-R"uckgebot} \label{1sarebid}
...
\notebox{\textbf{Ingberman} (frz. Moderateur): Nach einer Revers-Reizung
...
4\kar && 5/5\pl in den \ofa, kein \slamint (Weisberger) \\
...
\item Nach gegnerischem \conv{Informationskontra} ist eine neue Farbe auf der 2er-Stufe
  nicht forcierend.
...
\begin{description}
\item[1\pik{}\sep(2\kar){}\sep2\pik] ist m"oglich ab 0 FP mit
  3er-Anschluss.
...
\item[1\SA{}\sep(?)] ~
  ...
  \item[(\kontra)] ~
    ...
    \edsc
  \item[(2\,$x$)] \ra \conv{\Index{Lebensohl}} (\ref{lebensohl})
  \edsc
...
\item[2\tre{}\sep2\SA;] ~
  ...
  \item[(2\,Farbe)]
    ...
    \item[\kontra \dots] zweite Stufe \dots
    \edsc
  \item[(3\,Farbe)]
    \bdsc
    \item[pass] schlechtes Weak Two
    \item[\kontra] gutes Weak Two\footnote{Vielleicht gibt's was Besseres, keine Ahnung.}
    \edsc
  \edsc
\edsc

Alle anderen Gebote zeigen die starke Variante der Er"offung.
...
\item[2\coe{}\sep2\SA;] Frage nach St"arke und zweiter Farbe
  ...
  \item[3\tre] 6-10 FP, 5/5 \co/\tr
    ...
    \item[3\kar] Frage nach St"arke und K"urze
      ...
      \item[3\pik] 6-8 FP, \pi-K"urze (4\tre: \tr-, 4\kar: \co-PKCA)
      \item[3\SA] 9-10 FP, \ka-K"urze (4\tre: \tr-, 4\kar: \co-PKCA)
      \item[3\tre] 9-10 FP, \pik-K"urze (4\kar: \tr-, 4\pik: \co-PKCA)
      \edsc
    \edsc
...
\subsection{Sandwich \NT{} (1\SA/2\SA als Zweif"arber)}
...
Vor Mai 2005 war PKCA in den Ogust-Sequenzen immer mindestens 4\tre.
