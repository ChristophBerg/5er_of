...
\begin{compactitem}
\item[Minimum:] 11 gute bis 14 schlechte Punkte
\item[Medium:] 14 gute bis 16 Punkte
\item[Maximum:] ab 17 Punkten
\end{compactitem}

Mit einer Minimum-Hand reizt der Er"offner zun"achst 3\tre, mit einer Hand ab 17 Punkten zun"achst 3\kar{}.  Mit mittelstarken H"anden kann der Er"offner sofort eine K"urze zeigen.

Nach 3\tre und 3\kar kann der Antwortende den Er"offner nach K"urze fragen, nach 3\tre auch selbst eine K"urze zeigen (starke Splinter).  K"urzen werden grunds"atzlich genauso gezeigt wie als direkte Antwort auf 1\of{}-Er"offnung; dies gilt auch f"ur die Frage nach der Chicane-Farbe (siehe Abschnitt~\ref{ofsplinter} auf Seite~\pageref{ofsplinter}).

Grunds"atzlich reizt man mit Cue-Bids weiter; 4\SA ist RKCB.
...
\item[1\of{}\sep2\SA; ?]~
	...
	\item[3\tre] \mini (11-14\bad FP), beliebige Verteilung
		...
		\item[3\kar] Frage nach K"urze
			...
			\item[3\aof] beliebiges Chicane; \ra \rel Chicane-Farbe?
	...
	\item[3\aof] 14\good{}-16 FP, beliebiges Chicane; \ra \rel Chicane-Farbe?
...
\item[2\SA{}\sep3\tre] Frage nach 5er- und 4er-\ofa
    (Alert: \emph{"`verspricht keine 4er-\of"'})
  \bdsc
...
\item 2\SA verspricht nach \ofa-Er"offnung eine mindestens einladende Hand mit
  3\pl{}er-Anschluss (\emph{keine} partieforcierende Hebung).
...
Bei St"orung durch die Gegner nach dem 2\SA-Relais gilt
