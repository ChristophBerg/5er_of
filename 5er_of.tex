...
\item[1\tre\sep1\kar; ?]~
  ...
  \item[1\SA] 12-14, eine oder beide \of\ m"oglich
    \bdsc
      ...
      \item[2\SA] \nat
      \item[3\tre/\co/\pi] \conv{\Index{Splinter}} mit 6er\kar
...
\item[1\tre\sep1\pik; ?]~
  ...
  \item[3\kar/\co] \conv{\Index{Splinter}}: 4er\pik, Single \ka/\co
...
\item[1\tre\sep1\pik; 1\SA] 12-14 FP \bal
  ...
  \item[3\pik] 6er\pik, leichtes \slamint\footnote{Einladende H"ande mit
...
\item[1\SA] ~
  ...
  \item[(\kontra)] ~
    ...
    \edsc
  \item[(2\,Farbe)] \ra\ \conv{\Index{Lebensohl}}
  \item[2\tre\sep(\kontra);] Gegner kontriert Stayman
    \bdsc
    \item[\rekontra] 5er-\tr
    \item[2\kar] 5er-\ka
...
\bdsc
\item[3\NT] \conv{Gambling}\index{Gambling}
  \bdsc
  ...
  \item[4\kar] Frage nach K"urze
    ...
    \item[4\SA] keine K"urze (2227 oder 2272-Vert.)
    \item[5\tre] \ka-K"urze (!)
    \item[5\kar] \tr-K"urze (!)
    \edsc
...
Nach [(1\ofa)\sep\kontra\sep(2\ofa)] ist 2\SA\ \Index{Lebensohl}, ebenfalls
nach \Index{Weak Two}- Er"offnung: [(2\ofa)\sep\kontra\sep(pass)].
...
5er-Farbe. 2\SA\ vom \eo\ ist Ogust\index{Ogust} (\ra \ref{ogust}).
...
des Partners, also nach 2\coe/\pi/3\tre/\ka/\co/\pi/4\coe/\pi.
...
{
  \Meaning{a}{EKCB, hier kein Splinter, da wir den Fit schon haben}
}
