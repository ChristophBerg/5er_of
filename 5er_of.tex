...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Walsh-Sequenzen %%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
\subsubsection{Die \conv{Walsh}-Antwort auf 1\tre-Er"offnung}

Der Antwortende zeigt nach 1\tre-Er"offnung immer sofort eine
4er-\ofa, es sei denn
\begin{compactitem}
\item er h"alt mindestens ein 7er-\ka, oder
...
\emph{immer} eine unausgeglichene Hand mit langen Treffs.

\subsubsection{\conv{Wolff Sign Off} nach 2\SA-R"uckgebot}
...
sollen.  Nach dem forcierten 3\kar-Gebot des Er"offners kann er
passen, 3\coe zum Spielen oder Ausbessern anbieten, oder ein
beliebiges Gebot zum Spielen abgeben.
...
\bdsc
  \item[1\tre{}\sep1\kar; 2\SA{}\sep{}?]~
    ...
    Reizt der Antwortende in dieser Situation 3\of (verspricht ab 12
    Punkten), so ist meistens ein Schlemm m"oglich.  Der Er"offner
    beantwortet daher mit Fit in \ufa sofort die Assfrage auf
    \ufa-Basis (andernfalls Sign Off in \SA oder \ofa).
...
\subsubsection{Bietsequenzen nach Revers-Reizung}

\bdsc
  \item[1\tre{}\sep1\pik; 2\kar{}\sep{}?]~

    \conv{Revers} zeigt 16\good{}\pl und ist selbstforcierend f"ur
    \eo.
    \bdsc
...
Revers.  Der Er"offner zeigt mit 2\SA eine ausgeglichene, passbare Hand.
...
\subsubsection{Schwache und einladende Stayman-Sequenzen}
...
\subsubsection{Starke Stayman-Sequenzen}
...
\item eine \textbf{ausgeglichene Hand} mit 22-23 oder 26-27~FP oder
...
\item ein \textbf{Partieforcing} in einer beliebigen Farbe
  (18\pl FP, 6\pl{}er-Farbe, 9 Spielstiche),
\item eine \textbf{ausgeglichene Hand} mit 24-25 oder 28\pl~FP oder
...
weiteren 5er-Farbe im Bereich von 5-10 FP. In dritter Hand kann die Verteilung
auch 5/4 sein.
...
\item Neue Farbe im Sprung ist \conv{Fit Jump}.
