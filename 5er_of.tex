...
\subsection*{Verteidigung gegen obige 2\tre{}/2\kar{}-Er"offnungen}

Gegen eine 2\tre{}/2\kar{}-Er"offnung wie oben beschrieben, die ein \conv{Weak Two} in Karo bzw. Coeur enthalten kann, verteidigen wir wie folgt:
\bdsc
	...
	\bdsc
		...
		\item[2\kar{}/2\coe{}] wie ein Informationskontra gegen eine \conv{Weak-Two}-Er"offnung in dieser Farbe
	\edsc
\edsc
Alle anderen Gebote sind nat"urlich, und es wird von der schwachen Variante der Er"offnung ausgegangen.
...
\item von \cards{AK} wird \cards{K} ausgespielt
\end{itemize}
