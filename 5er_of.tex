...
Antworten mit Fit in \ofa: \conv{Bergen-Hebungen}, \conv{Splinter},
2\SA-Partieforcing (\ref{majorgf}).

Antworten mit Fit in \ufa: \conv{Inverted}.

Sonstige Antworten: Schwache Spr"unge, nat"urliche \sa (nach \ufa).

\minisec{R"uckgebot}

Mit einem Einf"arber wiederholt der Er"offner seine Farbe. Nach 1/1
und 16+ FP wird im Sprung eingeladen. Nach 2/1 zeigt der Sprung \dots

Mit einem Zweif"arber zeigt der Er"offner nun seine 2. Farbe, falls m"oglich
auf der 1er-Stufe. Ist diese rangniedriger, so zeigt er sie nach \conv{1/1}
immer, falls rangh"oher, nur wenn er 16\good\pl FP hat (\conv{Revers},
\ref{revers}), ansonsten wiederholt er seine 1. Farbe.
