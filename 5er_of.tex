...
\hline
\pf & \conv{Stayman} + \conv{Smolen} & 4\kar\\
\hline
\pf\ (stark) & \conv{Stayman} + \conv{Smolen} & \conv{Transfer}\\
\hline
Schlemm & \multicolumn{2}{|c|}{\conv{Stayman} + \conv{Smolen}}\\
\hline
\end{tabular}
...
\begin{itemize}
\item Die rangniedrigere der gegnerischen Farben steht f"ur die
  rangniedrigere unserer Farben.
\item Die rangh"ohere der gegnerischen Farben steht f"ur die
  rangh"ohere unserer Farben.
\item Direktes Heben der er"offneten Farbe zeigt Anschluss und ist
  rein kompetitiv.
\item Indirektes Heben der er"offneten Farbe (durch Reizen der
  entsprechenden gegnerischen Farbe) ist mindestens einladend und
  zeigt Anschluss.
...
\item Indirektes Reizen der freien Farbe zeigt 5er-L"ange und ist nur
  einladend.
\item \conv{Kontra} zeigt Straf-Bereitschaft f"ur eine der beiden
  gegnerischen Farben.
\end{itemize}
