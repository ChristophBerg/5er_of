...
andere \of\ gezeigt:
\bdsc
\item[{[}1\coe\sep3\pik;{]}] beliebiges Chicane, \ra\ 3\SA\ \rel, Frage nach
  dem Chicane
  \bdsc
    \item[4\tre] \tr-Chicane
  ...
  \edsc
\item[{[}1\pik\sep3\coe;{]}] beliebiges Chicane, \ra\ 3\pik\ \rel, Frage nach
  dem Chicane
  \bdsc
...
Die 1\SA-Gegenreizung zeigt 15-18 FP und \stp. Weiterreizung wie nach
...
3er-Stufe partieforcierend. Prioritäten des Antwortenden:
...
\subsubsection{Responsive \kontra}

\subsubsection{Competitive \kontra}

\subsubsection{Ausspielkontra}
